...
# Job Board
JOB_POSTING_ETH_ADDRESS = env('JOB_POSTING_ETH_ADDRESS', default='0x00De4B13153673BCAE2616b67bf822500d325Fc3')
# Job posting fee in ether
JOB_POSTING_ETH_FEE = env('JOB_POSTING_ETH_FEE', default=0.1)
